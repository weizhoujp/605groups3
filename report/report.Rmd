...
![](D:/project/platform_win.png)

This plot compares performance on different platforms and the x-axis is the map name. Generally, Xbox one and Ps4 have similar win rate while PC shows lower win rate.

![](D:/project/gamemode_win.png)
